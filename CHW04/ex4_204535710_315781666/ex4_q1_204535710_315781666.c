...
/*
	Functions in this region are responsible for updating specific fields of the product type.
	They all take as an argument a defined product and ask the user for the value needed
*/
...
void UserSelect(int action, super_market* super) {
	/*
	Inputs: :action: - The action choice of the user
	Return: None.
	Functionality: Navigate to the relevant function for the user selected action.
	*/
	switch(action)
		{
		case ADD:
...
super_market* GetNewSupermarket() {
	/*
	Inputs: None.
	Return: Pointer to an allocated super_market type.
	Functionality: Allocate memory for the supermarket, If allocation fails this function will exit the program
	*/
